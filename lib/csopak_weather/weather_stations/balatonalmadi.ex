defmodule Balatonalmadi do
  import Utilities, only: [log_fn_start: 0]

  # WG related data for this station
  def uid(), do: System.fetch_env!("ALMADI_WEATHER_UID")
  def password(), do: System.fetch_env!("ALMADI_WEATHER_API_PASSWORD")

  # Source related data
  def url(), do: "https://m.met.hu/balaton/telepules/balatonalmadi"
